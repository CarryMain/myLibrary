...
/* harmony import */ var _modules_display__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/display */ "./src/js/lib/modules/display.js");
...
/* harmony import */ var _modules_handlers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/handlers */ "./src/js/lib/modules/handlers.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function (selector) {
  let counter = 0;
  for (let i = 0; i < this.length; i++) {
    const closeEl = this[i].closest(selector);
    if (closeEl == null) {
      this[i] = true;
    }
    counter++;
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttr = function (typeName, name) {
  for (let i = 0; i < this.length; i++) {
    this[i].setAttribute(typeName, name);
  }
  return this;
};
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttr = function (typeName) {
  for (let i = 0; i < this.length; i++) {
    this[i].removeAttribute(typeName);
  }
  return this;
};
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.getAttr = function (typeName) {
  for (let i = 0; i < this.length; i++) {
